...
from utils import extract_tag, selectors
    ...
    if request.method == "POST":
        ...
        while url:
            ...
            try:
                ...
                url = None
        with open(f"./data/opinions/{product_code}.json", "w", encoding="UTF-8") as jf:
...
def product(product_code):
    opinions = pd.read_json(f"./data/opinions/{product_code}.json")
